...
WebUI.click(findTestObject('Modal_Transfer RTGS/qddown_inputTgl'))
...
WebUI.takeFullPageScreenshot(((('D:/.Katalon SS/TFRTGSDate' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')

WebUI.click(findTestObject('Modal_Transfer RTGS/qbutton_Transfer'))
...
'capture'
WebUI.takeFullPageScreenshot(((('D:/.Katalon SS/TFRTGSDate1' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
