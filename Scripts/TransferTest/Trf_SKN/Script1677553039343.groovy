...
WebUI.takeScreenshot(((('D:/.Katalon SS/TFSKN' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
...
'capture'
WebUI.takeFullPageScreenshot(((('D:/.Katalon SS/TFSKN1' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
