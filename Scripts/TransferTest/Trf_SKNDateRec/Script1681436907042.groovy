...
WebUI.click(findTestObject('Modal_Transfer LLG SKN/q_setReccur'))

WebUI.click(findTestObject('Modal_Transfer LLG SKN/q_frequency'))

WebUI.click(findTestObject('Modal_Transfer LLG SKN/q_selectFrequency'))

WebUI.click(findTestObject('Modal_Transfer LLG SKN/q_startDate'))

WebUI.click(findTestObject('Modal_Transfer LLG SKN/q_selectStartDate'))

WebUI.click(findTestObject('Modal_Transfer LLG SKN/q_endDate'))

WebUI.click(findTestObject('Modal_Transfer LLG SKN/q_nextMonth'))

WebUI.click(findTestObject('Modal_Transfer LLG SKN/q_selectEndDate'))

WebUI.scrollToElement(findTestObject('Object Repository/Modal_Transfer LLG SKN/qinput_Customer Number'), 5)
...
WebUI.takeFullPageScreenshot(((('D:/.Katalon SS/SKNDateRec' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
...
'capture'
//WebUI.takeFullPageScreenshot(((('D:/.Katalon SS/TFSKNDateRec2' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
