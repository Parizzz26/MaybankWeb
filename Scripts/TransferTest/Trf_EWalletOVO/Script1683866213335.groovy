...
'select OVO'
WebUI.click(findTestObject('Page_Transfer/qval_PayeeOVO'))

'input transaction detail'
WebUI.setText(findTestObject('Modal_Transfer EWallet/qinput_Customer Number'), customerNumber)

WebUI.setText(findTestObject('Modal_Transfer EWallet/qinput_Transfer Amount'), GlobalVariable.AMOUNT)
...
//WebUI.takeScreenshot(((('D:/.Katalon SS/EWallet' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
...
//WebUI.takeFullPageScreenshot(((('D:/.Katalon SS/EWallet(1)' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
'Capture'
