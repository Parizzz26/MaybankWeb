...
WebUI.click(findTestObject('Modal_TransferWithinMaybank/q_setReccur'))

WebUI.click(findTestObject('Modal_TransferWithinMaybank/q_frequency'))

WebUI.click(findTestObject('Modal_TransferWithinMaybank/q_selectFrequency'))

WebUI.click(findTestObject('Modal_TransferWithinMaybank/q_startDate'))

WebUI.click(findTestObject('Modal_TransferWithinMaybank/q_selectStartDate'))

WebUI.click(findTestObject('Modal_TransferWithinMaybank/q_endDate'))

WebUI.click(findTestObject('Modal_TransferWithinMaybank/q_selectEndDate'))
...
WebUI.takeScreenshot(((('D:/.Katalon SS/TFWithinMaybankDateRec' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')

'button transfer'
WebUI.click(findTestObject('Modal_TransferWithinMaybank/qbutton_Transfer Within Maybank'))
...
'take screenshot accepted screen'
WebUI.takeFullPageScreenshot(((('D:/.Katalon SS/TFWithinMaybankDateRec(1)' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + 
    '.png')
