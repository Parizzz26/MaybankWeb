...
WebUI.takeScreenshot(((('D:/.Katalon SS/TFRTGS' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
...
'capture'
WebUI.takeFullPageScreenshot(((('D:/.Katalon SS/TFRTGS1' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
