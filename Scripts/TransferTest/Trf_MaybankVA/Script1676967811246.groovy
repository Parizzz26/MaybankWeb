...
'select myb virtual account'
WebUI.click(findTestObject('Page_Transfer/qval_Transfer Maybank VA'))
...
WebUI.takeScreenshot(((('D:/.Katalon SS/TFMaybankVA' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
...
'capture'
WebUI.takeFullPageScreenshot(((('D:/.Katalon SS/TFMaybankVA' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
