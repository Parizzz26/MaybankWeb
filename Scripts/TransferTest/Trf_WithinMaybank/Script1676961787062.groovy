...
//WebUI.takeScreenshot(((('D:/.Katalon SS/TFWithinMaybank' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
'button transfer'
...
WebUI.waitForElementVisible(findTestObject('Page_Result/qh1_Test Transaksi Sukses'), 15)
