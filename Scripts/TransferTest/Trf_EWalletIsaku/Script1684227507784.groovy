...
'select GoPay'
WebUI.click(findTestObject('Page_Transfer/qval_Payee ISAKU'))
...
//WebUI.takeScreenshot(((('D:/.Katalon SS/TrfEWalletIsaku' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
...
//WebUI.takeFullPageScreenshot(((('D:/.Katalon SS/TrfEWalletIsaku(1)' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
'capture'
