...
WebUI.click(findTestObject('Modal_TransferOwnAccount/q_setReccur'))

WebUI.click(findTestObject('Modal_TransferOwnAccount/q_frequency'))

WebUI.click(findTestObject('Modal_TransferOwnAccount/q_selectFrequency'))

WebUI.click(findTestObject('Modal_TransferOwnAccount/q_startDate'))

WebUI.click(findTestObject('Modal_TransferOwnAccount/q_selectStartDate'))

WebUI.click(findTestObject('Modal_TransferOwnAccount/q_endDate'))

WebUI.click(findTestObject('Modal_TransferOwnAccount/q_nextMonth'))

WebUI.click(findTestObject('Modal_TransferOwnAccount/q_selectEndDate'))
...
//WebUI.takeScreenshot(((('D:/.Katalon SS/TFOwnAccountDateRec' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')

WebUI.takeFullPageScreenshot(((('D:/.Katalon Present/TFOwnAccountDateRec' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
...
//WebUI.takeFullPageScreenshot(((('D:/.Katalon SS/TFOwnAccountDateRec(1)' + GlobalVariable.TIMESTAMP) + '_') + nowTime) + '.png')
