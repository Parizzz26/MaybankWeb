...
def transactionType = 'Pembelian Tiket'
...
WebUI.click(findTestObject('Modal_PrcTiket/qdropdown_tiket'))

WebUI.click(findTestObject('Modal_PrcTiket/qdropdown_serviceType'))

WebUI.click(findTestObject('Modal_PrcTiket/qval_tiket'))

WebUI.setText(findTestObject('Modal_PrcTiket/qinput_custNo'), custNumber)

WebUI.click(findTestObject('Modal_PrcTiket/qbutton_Purchase'))
