...
def transactionType = 'Pembayaran Zakat Dompet Dhuafa'
...
WebUI.click(findTestObject('Modal_Zakat/qddown_listOtherBill'))

'select payee'
WebUI.click(findTestObject('Modal_Zakat/qddown_slcPayee'))

'select provider'
WebUI.click(findTestObject('Modal_Zakat/qdropdown_listPayee'))
