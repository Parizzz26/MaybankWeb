...
def transactionType = 'Pembayaran Education Laurensia'
...
WebUI.click(findTestObject('Modal_Edu/qddown_listOtherBill'))

WebUI.click(findTestObject('Modal_PaypersonalLoan/qddown_slcPayee'))

WebUI.click(findTestObject('Modal_Edu/qdropdown_listPayee'))
