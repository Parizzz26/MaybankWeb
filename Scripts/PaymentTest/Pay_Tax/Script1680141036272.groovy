...
def transactionType = 'Pembayaran Tax Taksasi KPR'
...
WebUI.click(findTestObject('Modal_PayTax/qddown_listOtherBill'))

WebUI.click(findTestObject('Modal_PaypersonalLoan/qddown_slcPayee'))

WebUI.click(findTestObject('Modal_PayTax/qdropdown_listPayee'))
