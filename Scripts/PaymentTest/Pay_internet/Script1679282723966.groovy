...
def transactionType = 'Pembayaran Internet Centrin'
...
'select pembayaran ex. internet, tv kabel, dll'
WebUI.click(findTestObject('Modal_Internet/qddown_listOtherBill'))

'select payee'
WebUI.click(findTestObject('Modal_Internet/qddown_slcPayee'))

'select provider'
WebUI.click(findTestObject('Modal_Internet/qdropdown_listPayee'))

WebUI.setText(findTestObject('Modal_Internet/qinput_custNo'), custNo)

WebUI.setText(findTestObject('Modal_Internet/qinput_payAmount'), amount)

WebUI.setText(findTestObject('Modal_Internet/qinput_msg'), msg)
