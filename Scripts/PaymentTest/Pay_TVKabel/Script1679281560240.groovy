...
def transactionType = 'Pembayaran TV Kabel AORA TV'
...
'field klik select biller'
WebUI.click(findTestObject('Modal_PaypersonalLoan/qdropdown_bills'))

'select pembayaran ex. tv kabel'
WebUI.click(findTestObject('Modal_PayTVKabel/qddown_listOtherBill'))

'select payee'
WebUI.click(findTestObject('Modal_PaypersonalLoan/qddown_slcPayee'))

'select provider'
WebUI.click(findTestObject('Modal_PayTVKabel/qdropdown_listPayee'))

WebUI.setText(findTestObject('Modal_PayTVKabel/qinput_custNo'), custNo)

WebUI.setText(findTestObject('Modal_PayTVKabel/qinput_payAmount'), amount)

WebUI.setText(findTestObject('Modal_PayTVKabel/qinput_msg'), msg)
...
WebUI.scrollToElement(findTestObject('Object Repository/Page_Maybank2u/q_burgerMenu'), 5)
...
WebUI.navigateToUrl(GlobalVariable.EMAILURL)

CustomKeywords.'MyKeywords.loginEmail'()

CustomKeywords.'MyKeywords.validasiEmail'()
