...
def transactionType = 'Pembayaran Asuransi AIA'
...
WebUI.click(findTestObject('Modal_PayInsurance/qdropdown_bills'))

WebUI.click(findTestObject('Modal_PayInsurance/qddown_listOtherBill'))

WebUI.click(findTestObject('Modal_PayInsurance/qddown_slcPayee'))

WebUI.click(findTestObject('Modal_PayInsurance/qdropdown_listInsurance'))

WebUI.setText(findTestObject('Modal_PayInsurance/qinput_custNo'), custNo)

WebUI.setText(findTestObject('Modal_PayInsurance/qinput_payAmount'), amount)

WebUI.setText(findTestObject('Modal_PayInsurance/qinput_msg'), msg)

WebUI.click(findTestObject('Modal_PayInsurance/qbutton_pay'))
