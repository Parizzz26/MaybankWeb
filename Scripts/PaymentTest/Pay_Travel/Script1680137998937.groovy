...
def transactionType = 'Pembayaran Travel Graha Tour'
...
WebUI.click(findTestObject('Modal_PayTravel/qddown_listOtherBill'))

WebUI.click(findTestObject('Modal_PaypersonalLoan/qddown_slcPayee'))

WebUI.click(findTestObject('Modal_PayTravel/qdropdown_listPayee'))
