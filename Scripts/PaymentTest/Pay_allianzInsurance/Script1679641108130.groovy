...
def transactionType = 'Pembayaran Asuransi Allianz'
...
WebUI.click(findTestObject('Modal_PayInsurance/qdropdown_listInsurance - Copy'))

WebUI.setText(findTestObject('Modal_PayInsurance/qinput_custNo'), noVA)
