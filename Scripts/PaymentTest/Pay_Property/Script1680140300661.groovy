...
def transactionType = 'Pembayaran Property AKR'
...
WebUI.click(findTestObject('Modal_PayProperty/qddown_listOtherBill'))

WebUI.click(findTestObject('Modal_PaypersonalLoan/qddown_slcPayee'))

WebUI.click(findTestObject('Modal_PayProperty/qdropdown_listPayee'))
