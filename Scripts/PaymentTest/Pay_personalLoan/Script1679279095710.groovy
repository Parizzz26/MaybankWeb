...
def transactionType = 'Pembayaran Personal Loan HSBC KTA'
...
WebUI.click(findTestObject('Modal_PaypersonalLoan/qddown_listOtherBill'))

WebUI.click(findTestObject('Modal_PaypersonalLoan/qddown_slcPayee'))

WebUI.click(findTestObject('Modal_PaypersonalLoan/qdropdown_listPayee'))

WebUI.setText(findTestObject('Modal_PaypersonalLoan/qinput_custNo'), custNo)

WebUI.setText(findTestObject('Modal_PaypersonalLoan/qinput_payAmount'), amount)

WebUI.setText(findTestObject('Modal_PaypersonalLoan/qinput_msg'), msg)
